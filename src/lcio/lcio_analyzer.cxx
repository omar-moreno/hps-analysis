 ...
 *		   them using analyses of type LcioAnalysis.
...
int main(int argc, char** argv) { 
	...
	int option_index = 0; 
	int option_char; 
	while ((option_char = getopt_long(argc, argv, "i:", long_options,
			&option_index)) != -1) { 
		switch (option_char) { 
			case 'i': 
	...
	// If an input LCIO file was not specified, warn the user and exit the 
	// program
